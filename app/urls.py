...
auth.add_url_rule('/confirm', view_func=confirm_email_view, methods=['GET'])
email_confirm.add_url_rule('/confirm_page', view_func=confirm_email_page, methods=['GET'])
chat_blueprint.add_url_rule('/', view_func=handle_chat_page)
